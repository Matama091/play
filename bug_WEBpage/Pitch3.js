...
function getSModifier(e) {
  ...
  var Pitch = {
    ...
    start: function() {
      if ("" !== Pitch.parseError && "none" !== Pitch.parseError) {
        // return Pitch.progressText.html(Pitch.defaultText),
          return Pitch.progressText.html("aaa"),
    ...
    updateText: function(e) {
      //Pitch.progressText.textContent = "a";
      // e && Pitch.progressText.textContent(e);
    },
  ...
  $(function() {
    Pitch.staticArea = $("#static"),
      Pitch.staticArea.width($(window).width() - 20),
      Pitch.staticArea.height($(window).height() - 20),
      Pitch.progressText = document.getElementById('progressText'),
      ...
      console.log(Pitch.progressText.textContent)
